...
# Confirms a logged-in user.
   ...
   def generate_pdf
    ...
    @improve = Survey::Attempt.where(participant_id: current_user.id, numericGrade: [2...3])
    @deltas = Survey::Attempt.where(participant_id: current_user.id, numericGrade: [0...2])
