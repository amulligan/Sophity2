...
# Confirms a logged-in user.
   ...
   def generate_pdf
    ...
    @proficient = Survey::Attempt.where(participant_id: current_user.id, numericGrade: [3.2 .. 5.0])
    @improve = Survey::Attempt.where(participant_id: current_user.id, numericGrade: [2.3 ... 3.2])
